...
def build_faiss_index():
    ...
    # 4. 生成 item embedding
    # ⚠️ 修复关键点：严格用 idx2item 顺序保证 item_id 和 embedding 对齐
    ...
    item_text_feats = torch.tensor([dataset.item_text_feats[iid] for iid in ordered_item_ids], dtype=torch.float)
